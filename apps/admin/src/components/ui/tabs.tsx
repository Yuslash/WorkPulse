...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-11 items-center justify-center rounded-2xl bg-elevated/80 p-1.5 text-muted border border-border/70 shadow-warm-sm',
      className
    )}
    {...props}
  />
