...
function createCollection(name) {
  ...
  const CollectionProvider = __name5((props) => {
  ...
  __name5(useCollection2, "useCollection");
  return [
...
var DirectionProvider = __name11((props) => {
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React12.useState(_isHydrated);
  React12.useEffect(() => {
    if (!_isHydrated) {
      _isHydrated = true;
      setIsHydrated(true);
...
__name12(useIsHydratedModern, "useIsHydratedModern");
...
var RovingFocusGroup = React13.forwardRef(
  ...
  __name13(function RovingFocusGroup2(props, forwardedRef) {
...
var RovingFocusGroupImpl = React13.forwardRef(__name13(function RovingFocusGroupImpl2(props, forwardedRef) {
  const {
...
var RovingFocusGroupItem = React13.forwardRef(
  // blank line to reduce diff noise
  __name13(function RovingFocusGroupItem2(props, forwardedRef) {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
      active = false,
...
__name13(getDirectionAwareKey, "getDirectionAwareKey");
...
__name13(getFocusIntent, "getFocusIntent");
...
__name14(useStateMachine, "useStateMachine");
var Presence = __name14((props) => {
...
function usePresence(present) {
  ...
  useLayoutEffect2(() => {
    if (node) {
      ...
      const handleAnimationEnd = __name14((event) => {
      ...
      const handleAnimationStart = __name14((event) => {
...
__name14(usePresence, "usePresence");
...
__name14(useStableComposedRefs, "useStableComposedRefs");
function getAnimationName(styles) {
  return (styles == null ? void 0 : styles.animationName) || "none";
}
__name14(getAnimationName, "getAnimationName");
...
__name14(getElementRef2, "getElementRef");
...
var Tabs = React15.forwardRef(
  // blank line to reduce diff noise
  __name15(function Tabs2(props, forwardedRef) {
    const {
      __scopeTabs,
      value: valueProp,
      onValueChange,
...
var TabsList = React15.forwardRef(
  // blank line to reduce diff noise
  __name15(function TabsList2(props, forwardedRef) {
...
var TabsTrigger = React15.forwardRef(
  __name15(function TabsTrigger2(props, forwardedRef) {
...
var TabsContent = React15.forwardRef(
  __name15(function TabsContent2(props, forwardedRef) {
...
__name15(makeTriggerId, "makeTriggerId");
function makeContentId(baseId, value) {
  return `${baseId}-content-${value}`;
}
__name15(makeContentId, "makeContentId");
var Root2 = Tabs;
var List = TabsList;
